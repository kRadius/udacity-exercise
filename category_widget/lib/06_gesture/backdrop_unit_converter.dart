...
class BackdropUnitConverter extends StatefulWidget {
  ...
  const BackdropUnitConverter({
    @required this.category,
  }) : assert(category != null);

  @override
  _BackdropUnitConverterState createState() => _BackdropUnitConverterState();
}

class _BackdropUnitConverterState extends State<BackdropUnitConverter> {
  Unit _fromValue;
  Unit _toValue;
  double _inputValue;
